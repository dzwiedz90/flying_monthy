...
urlpatterns = [
                  ...
                  path('change_status/<int:pk>/', change_user_status,
                       name='change_status'),
                  ...
                  path('post/api/memes/', MemeRestApi.as_view(),
                       name='post/api/memes/'),
                  path('post/api/user_memes/', GetMemesOfUser.as_view(),
                       name='user_memes'),
                  path('api/users/user_profile', user_profile_rest,
                       name='user_profile'),
